...
def build_requirements() -> list[RequirementEvidence]:
    ...
    return [
        ...
        pass_if(
            ...
            and exists("outputs/event_context_corpus/frozen_context_integrity_report.md")
            and "Forbidden target-field hits in allowed fact summaries: `0`" in frozen_context_audit,
            "Frozen event-context corpus exists",
            "ACS/BTS context facts, PSRC validation-only evidence, 89 frozen-context batch prompts, prompt leakage audit, and SHA256 integrity manifest are documented.",
        ...
        pass_if(
            ...
            and "weighted macro F1 `0.4663`" in read_text("outputs/mode_choice_transfer/mode_choice_transfer_report.md"),
            "Trip-level mode-choice transfer baseline exists",
            "2017-trained survey-weighted harmonized MODE_GROUP XGBoost transfer baseline is reported with weighted accuracy, weighted balanced accuracy, weighted macro F1, and rare-mode limitations.",
