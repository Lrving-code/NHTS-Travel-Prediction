...
The trip-level survey-weighted harmonized mode-choice transfer baseline reaches 2022 weighted accuracy `0.9297`, weighted balanced accuracy `0.4343`, and weighted macro F1 `0.4663`; it is useful behavior-system evidence, but rare modes remain hard.
