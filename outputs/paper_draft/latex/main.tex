...
\begin{itemize}
    ...
    \item Poisson GLM reaches \whmae{} 4.3368 and Tweedie GLM reaches 4.3761; solver diagnostics are recorded, so these should be read as transparent count-model baselines rather than exhaustively optimized count-model state of the art.
