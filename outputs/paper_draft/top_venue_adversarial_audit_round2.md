...
| LLM pretraining/vendor leakage | GPT-style models may know post-pandemic mobility facts, and a single proprietary endpoint may limit reproducibility | A CUDA-enabled 32-cohort local Qwen sensitivity control now exists; stronger local models or calibration are still needed before claiming open-source equivalence |
