...
| Trip-level mode-choice transfer baseline exists | PASS | 2017-trained harmonized MODE_GROUP XGBoost transfer baseline is reported with accuracy, balanced accuracy, macro F1, and rare-mode limitations. | `outputs/mode_choice_transfer/mode_choice_transfer_report.md` |
